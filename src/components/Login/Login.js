            ...
            <section className="authorization__container">
                ...
                <form className="authorization__form" onSubmit={handleSubmit} noValidate>
                    <div className="authorization__label">
                        ...
                        <input value={values.email || ""} type="email" placeholder="Email" onChange={handleChange} pattern="^([^ ]+@[^ ]+\.[a-z]{2,6}|)$" className="authorization__input authorization__input_type_email" id="email-input" required />
                    ...
                    <div className="authorization__label">
                        ...
                        <input value={values.password || ""} onChange={handleChange} type="password" placeholder="Пароль" className="authorization__input authorization__input_type_password" id="password-input" minLength="2" maxLength="200" required />
